...
output: 
  html_document: 
    ...
    theme: united
---
#NHTS Summarizer - Demo
####[AlexanderCates@westat.com](mailto:AlexanderCates@westat.com)
####[AnthonyFucci@westat.com](mailto:AnthonyFucci@westat.com)
####[MarceloSimas@westat.com](mailto:MarceloSimas@westat.com)

This document will show you how to create contingency tables, maps, and other visualizations using the [2009 National Household Travel Survey public-use dataset](http://nhts.ornl.gov/download.shtml). Understanding this demo may allow you to import other weighted datsets for analysis.
